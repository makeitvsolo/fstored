...
public class RemoveFolderUsecaseTests extends FstoredStorageApplicationUnitTest {
    ...
    @InjectMocks
    private RemoveFolderUsecase<TestHandle> usecase;

    @Mock
    private TestHandle handle;

    @Test
    public void invoke_RemovesFolder() {
    ...
    @Test
    public void invoke_Throws_WhenFolderDoesNotExists() {
        var payload = new FolderDto("root", "/name/");
